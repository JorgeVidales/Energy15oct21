  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Compañia", align: "start", value: "compania" },
        { text: "Estación", align: "start", value: "estacion" },
  ...
  methods: {
    ...
    desactivarCliente(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "Esta seguro de desactivar esta estación?",
          icon: "warning",
    ...
    activarCliente(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "Esta seguro de activar esta estación?",
          icon: "warning",
          showCancelButton: true,
          confirmButtonText: "Aceptar!",
          cancelButtonText: "Cancelar!",
    ...
    editItem(item) {
      ...
      let idCompania = this.editedItem.idCompania;
      let compania = this.editedItem.compania;

      this.select = { id: idCompania, compania: compania};
    ...
    registrarCliente() {
      ...
      axios
        .post("/estacion/registrar", {
          // compania: me.select.id,

          idCompania: me.select.id,
          // cliente: me.select.compania,
          estacion: me.editedItem.estacion,
    ...
    validarCliente() {
      ...
      // alert(me.select.compania);

      if (!me.select.compania)
        this.errorMostrarMsjCliente.push(
          "El nombre del cliente no puede estar vacío"
        );

      if (!me.editedItem.estacion)
        this.errorMostrarMsjCliente.push(
          "El nombre de la estación no puede estar vacío"
        );
